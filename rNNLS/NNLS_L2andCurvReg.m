...
% this also adds a small L2-regularization to the curvature regularization
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [ xOut, ChiUsed, resid, xUnreg] = NNLS_L2andCurvReg(A,Decay,Lambda)
...
%Curvature
T2length = length( A(1,:) );
H = 1.1*eye(T2length,T2length) - diag(ones(T2length-1,1),1)./2 - diag(ones(T2length-1,1),-1)./2;
%Curvature regularization; standard L2-norm regularition acts stronger on intense peaks than on weak peaks.
H([1 end])=0.6; % the ends of the spectrum shall not be downregularized specifically.
