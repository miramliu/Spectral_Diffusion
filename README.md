...
Therefore, if you use any version of this code, please check out, and cite appropriately, "Continuous diffusion spectrum computation for diffusion-weighted magnetic resonance imaging of the kidney tubule system" by J. Periquito & T. Gladytz et al., https://doi.org/10.21037/qims-20-1360, "AnalyzeNNLS: Magnetic resonance multiexponential decay image analysis" by T.A. Bjarnason & J.R. Mitchel at https://doi.org/10.1016/j.jmr.2010.07.008, as well as "Quantification of multi-compartment flow from spectral diffusion of IVIM" by M.M. Liu et al., https://doi.org/10.48550/arXiv.2408.06427 and "Estimation of Multi-Component Flow in the Kidney with Multi-b-value Spectral Diffusion" MRM (under review). 
