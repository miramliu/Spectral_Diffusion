...
Therefore, if you use any version of this code, please check out, and cite appropriately, ["Quantification of multi-compartment flow from spectral diffusion of IVIM" by M.M. Liu et al.](https://doi.org/10.48550/arXiv.2408.06427), ["Continuous diffusion spectrum computation for diffusion-weighted magnetic resonance imaging of the kidney tubule system" by J. Periquito & T. Gladytz et al.](https://doi.org/10.21037/qims-20-1360), as well as ["AnalyzeNNLS: Magnetic resonance multiexponential decay image analysis" by T.A. Bjarnason & J.R. Mitchel](https://doi.org/10.1016/j.jmr.2010.07.008).
